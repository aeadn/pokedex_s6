...
export const modal_DOM = {
    ...
    tcgCardDetails: modal?.querySelector?.("[data-tcg-card-details]") || null,
    tcgDetailImage: modal?.querySelector?.("[data-tcg-detail-image]") || null,
    tcgDetailName: modal?.querySelector?.("[data-tcg-detail-name]") || null,
    tcgDetailInfos: modal?.querySelector?.("[data-tcg-detail-infos]") || null,
    tcgDetailAttacks: modal?.querySelector?.("[data-tcg-detail-attacks]") || null,
